...
<img src="https://github.com/soon2moon/penpot-mcp-experiments/blob/main/images/homepage.png?raw=true" width="100%" alt="Homepage" />
...
```
*The prompt that I used for my experiments. I also added a screenshot and the specific Svelte page file. For example, for the sidebar, I added the [screenshot](https://github.com/soon2moon/penpot-mcp-experiments/blob/main/images/sidebar.png?raw=true) and [svelte file](https://github.com/soon2moon/penpot-mcp-experiments/blob/main/src/lib/components/Sidebar.svelte).*

The Opus 4.5 capability to create Penpot designs is incredible. I added the prompt that I used for the sake of completeness, but it didn't make much difference. The only things that actually make a difference are saying "use flex layout" and "logically grouping the layers together".
...
| **Reference** | **Result** |
| :---: | :---: |
| <img src="https://github.com/soon2moon/penpot-mcp-experiments/blob/main/images/reference_images/ref_listening_activity.png?raw=true" width="250" alt="Reference Listening Activity" /> | <img src="https://github.com/soon2moon/penpot-mcp-experiments/blob/main/images/results/01_listening_stats_result.png?raw=true" width="250" alt="Result Listening Activity" /> |
...
| **Reference** | **Result** |
| :---: | :---: |
| <img src="https://github.com/soon2moon/penpot-mcp-experiments/blob/main/images/reference_images/ref_user_settings.png?raw=true" width="250" alt="Reference Manage Accounts" /> | <img src="https://github.com/soon2moon/penpot-mcp-experiments/blob/main/images/qwen3/01_result_UserSettingsCard_qwen3-32b.png?raw=true" width="250" alt="User Settings Card" /> |
